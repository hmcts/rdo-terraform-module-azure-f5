...
resource "null_resource" "ansible-runs" {
  ...
  provisioner "local-exec" {
    command = <<EOF
      ...
      openssl pkcs12 -in /home/vsts/work/1/s/star-platform-hmcts-net.pfx -out /home/vsts/work/1/s/hmcts_cert.key -nocerts -nodes -password 'pass:'
      openssl pkcs12 -in /home/vsts/work/1/s/star-platform-hmcts-net.pfx -out /home/vsts/work/1/s/hmcts_cert.pem -clcerts -nokeys -password 'pass:'
