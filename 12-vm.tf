...
resource "null_resource" "ansible-runs" {
  ...
  provisioner "local-exec" {
    ...
    command = <<EOF
      ...
      echo -e "\n" > /home/vsts/work/1/s/key.txt
      openssl pkcs12 -in /home/vsts/work/1/s/star-platform-hmcts-net.pfx -out /home/vsts/work/1/s/hmcts_cert.key -nocerts -nodes -passin file:/home/vsts/work/1/s/key.txt
